...
const unsigned char DD[] PROGMEM = {	// DEVICE Descriptor
	0x12,	       		// bLength = 18d
...
const unsigned char CD[] PROGMEM = {	// CONFIGURATION Descriptor
	0x09,			// bLength
...
const unsigned char RepD[] PROGMEM = {   // Report descriptor 
...
const unsigned char strDesc[][64] PROGMEM = {
